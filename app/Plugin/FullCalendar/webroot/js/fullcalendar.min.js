...
"Oktober","November","Dezember"],monthNamesShort:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],dayNames:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"],dayNamesShort:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"],buttonText:{prev:"&nbsp;&#9668;&nbsp;",next:"&nbsp;&#9658;&nbsp;",prevYear:"&nbsp;&lt;&lt;&nbsp;",nextYear:"&nbsp;&gt;&gt;&nbsp;",today:"Heute",month:"Monat",week:"Woche",day:"Tag"},theme:false,buttonIcons:{prev:"circle-triangle-w",next:"circle-triangle-e"},
...
hb({allDaySlot:true,allDayText:"Ganztagig",firstHour:6,slotMinutes:30,defaultEventMinutes:120,axisFormat:"H(:mm)tt",timeFormat:{agenda:"H:mm{ - H:mm}"},dragOpacity:{agenda:0.5},minTime:0,maxTime:24});Ea.addDays=S;Ea.cloneDate=C;Ea.parseDate=Xa;Ea.parseISO8601=Cb;Ea.parseTime=bb;Ea.formatDate=Ha;Ea.formatDates=Va;var Ca=["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"],kb=864E5,Rb=36E5,Qb=6E4,Sb={s:function(a){return a.getSeconds()},ss:function(a){return Ma(a.getSeconds())},m:function(a){return a.getMinutes()},
...
MMMM:function(a,b){return b.monthNames[a.getMonth()]},yy:function(a){return(a.getFullYear()+"").substring(2)},yyyy:function(a){return a.getFullYear()},t:function(a){return a.getHours()<12?"":""},tt:function(a){return a.getHours()<12?"":""},T:function(a){return a.getHours()<12?"":""},TT:function(a){return a.getHours()<12?"":""},u:function(a){return Ha(a,"dd-MM-yyyy'T'HH:mm:ss'Z'")},S:function(a){a=a.getDate();if(a>10&&a<20)return"th";return["st","nd","rd"][a%10-1]||"th"}}})(jQuery);
