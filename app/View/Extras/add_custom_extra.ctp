		...
		<div class="PostContent">
			<div class="PostContentBox">
				<div class="PostMainContentbox">
						...
						echo $this->Form->input('default_price',array('placeholder' => __('Enter the price '),'label' => __('Default Price for Houses (in €, €/m<sup>2</sup> or €/m)'),'div' => 'form-group has-success'));
