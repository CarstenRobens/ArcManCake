...
<h3><?php echo h($user_view['User']['name'].' '.$user_view['User']['surname'].' ('.$user_view['User']['username']).').'; ?> </h3>
...
<p> <b>Phone number: </b>  <?php echo h($user_view['User']['phone']); ?> </p>

<p> <b>E-mail: </b>  <?php echo h($user_view['User']['email']); ?> </p>
